        ...
        files: [
          {
            ...
            file_id: 'file-XXXXXXXXXXXXXXXXXXXX',
            filepath:
              'https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-XXXXXXXXXXXXXXXXXXXX/hp1.txt',
            usage: 1,
...
^1.^ hp1.txt`;
  ...
  test('handles multiple FILE_PATH annotations with sandbox links', async () => {
        ...
        files: [
          {
            ...
            file_id: 'file-XXXXXXXXXXXXXXXXXXXX',
            filepath:
              'https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-XXXXXXXXXXXXXXXXXXXX/dummy_data1.csv',
            usage: 1,
            user: 'XXXXXXXXXXXXXXXXXXXX',
          ...
          },
          {
            ...
            file_id: 'file-YYYYYYYYYYYYYYYYYYYY',
            filepath:
              'https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-YYYYYYYYYYYYYYYYYYYY/dummy_data2.csv',
            usage: 1,
            user: 'XXXXXXXXXXXXXXXXXXXX',
            context: 'assistants_output',
            source: 'openai',
          ...
          },
          {
            ...
            file_id: 'file-ZZZZZZZZZZZZZZZZZZZZ',
            filepath:
              'https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-ZZZZZZZZZZZZZZZZZZZZ/dummy_data3.csv',
            usage: 1,
            user: 'XXXXXXXXXXXXXXXXXXXX',
            context: 'assistants_output',
            source: 'openai',
    ...
    const expectedText =
      'I have generated three dummy CSV files for you. You can download them using the links below:\n\n1. [Download Dummy Data 1](https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-XXXXXXXXXXXXXXXXXXXX/dummy_data1.csv)\n2. [Download Dummy Data 2](https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-YYYYYYYYYYYYYYYYYYYY/dummy_data2.csv)\n3. [Download Dummy Data 3](https://ai.marcoleder.ch/v1/files/XXXXXXXXXXXXXXXXXXXX/file-ZZZZZZZZZZZZZZZZZZZZ/dummy_data3.csv)';
